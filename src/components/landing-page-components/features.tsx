...
function CoreFeatures() {
  return (
    <div className="h-[100vh] bg-[#233246] flex flex-col justify-between">
      <div className="flex flex-col items-center justify-center gap-[20px] h-[60%]">
      ...
      <div className="w-[1440px] h-[80%] flex  content-center mx-auto justify-between">
